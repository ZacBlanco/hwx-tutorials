...
<table class=" data-table" style="height: 68px;" width="719">
...
[http://hortonworks.com/hadoop-tutorial/hello-world-an-introduction-to-hadoop-hcatalog-hive-and-pig/#section_11](http://hortonworks.com/hadoop-tutorial/hello-world-an-introduction-to-hadoop-hcatalog-hive-and-pig/#section_11)
...
2015-07-28 04:57:07,883 [main] INFO org.apache.pig.Main – Apache Pig version 0.15.0.2.3.0.0-2557 (rexported) compiled Jul 14 2015, 10:10:23  
...
I am unable to connect to ambari server. I am using [http://127.0.0.1:8080](http://127.0.0.1:8080/) with username and password as admin. The services are up and running.
...
Hi Soumik,  
127.0.0.1 is normally used with the virtualbox image. So I assume you are either on VMware or Hypervisor. For either of those, you should see the console and it should display the ip address. Do you see an ip adress mentioned in the console?
...
[http://hortonworks.com/community/forums/forum/hortonworks-sandbox/](http://hortonworks.com/community/forums/forum/hortonworks-sandbox/)
...
### Leave a Reply <small>[Cancel reply](http://hortonworks.com/hadoop-tutorial/hello-world-an-introduction-to-hadoop-hcatalog-hive-and-pig/#respond)</small>
...
<label for="comment">Comment</label><textarea id="comment" name="comment" cols="45" rows="8" aria-describedby="form-allowed-tags" aria-required="true" required="required"></textarea>

If you have specific technical questions, please post them in the [Forums](http://hortonworks.com/community/forums/)

You may use these <abbr title="HyperText Markup Language">HTML</abbr> tags and attributes: `<a href="" title=""> <abbr title=""> <acronym title=""> <b> <blockquote cite=""> <cite> <code> <del datetime=""> <em> <i> <q cite=""> <s> <strike> <strong> <pre lang="" line="" escaped="" cssfile="">`

<input name="submit" type="submit" id="submit" class="submit" value="Post Comment"> <input type="hidden" name="comment_post_ID" value="74807" id="comment_post_ID"> <input type="hidden" name="comment_parent" id="comment_parent" value="0"> <input type="hidden" name="undefined" value="undefined">

<input type="hidden" id="akismet_comment_nonce" name="akismet_comment_nonce" value="ce75bc4812">
