...
### [](#exercise-hive-access-scenarios)Exercise Hive access scenarios
...
# su - mktg1  $ /usr/lib/hive/bin/beeline -u "jdbc:hive2://localhost:10000/default"  -n mktg1 -p mktg1 -d org.apache.hive.jdbc.HiveDriver  Connecting to jdbc:hive2://localhost:10000/default  Connected to:  Apache  Hive  (version 0.13.0.2.1.1.0-385)  Driver:  Hive JDBC (version 0.13.0.2.1.1.0-385)  Transaction isolation: TRANSACTION_REPEATABLE_READ Beeline version 0.13.0.2.1.1.0-385  by  Apache  Hive  0: jdbc:hive2://localhost:10000/default> select * from xademo.customer_details;  Error:  Error  while  compiling statement: FAILED:  HiveException org.apache.hadoop.hive.ql.metadata.AuthorizationException:  User  [mktg1] does not have [select] privilege on column [db:xademo,table:customer_details,column:imei]  (state=42000,code=40000)
...
[![](https://camo.githubusercontent.com/67dba55d707ef0a67c79d6d986dd2f5ebd3348e5/687474703a2f2f686f72746f6e6173736574732e73332e616d617a6f6e6177732e636f6d2f7475746f7269616c2f73656375726974792f48495645416363657373417564697444656e696564557365436173652e706e67)](https://camo.githubusercontent.com/67dba55d707ef0a67c79d6d986dd2f5ebd3348e5/687474703a2f2f686f72746f6e6173736574732e73332e616d617a6f6e6177732e636f6d2f7475746f7269616c2f73656375726974792f48495645416363657373417564697444656e696564557365436173652e706e67)

Run the same beeline command to validate access for `legal1` user-id which belongs to the `legal` group:



# su - legal1  $ /usr/lib/hive/bin/beeline -u "jdbc:hive2://localhost:10000/default"  -n legal1 -p legal1 -d org.apache.hive.jdbc.HiveDriver  Connecting to jdbc:hive2://localhost:10000/default  Connected to:  Apache  Hive  (version 0.13.0.2.1.1.0-385)  Driver:  Hive JDBC (version 0.13.0.2.1.1.0-385)  Transaction isolation: TRANSACTION_REPEATABLE_READ Beeline version 0.13.0.2.1.1.0-385  by  Apache  Hive  0: jdbc:hive2://localhost:10000/default> select * from xademo.customer_details;  +--------------------------------+------------------------+--------------------+  | customer_details.phone_number | customer_details.plan | customer_details.d |  +--------------------------------+------------------------+--------------------+  | PHONE_NUM | PLAN | DATE |  |  5553947406  |  6290  |  20130328  |  |  7622112093  |  2316  |  20120625  |  |  5092111043  |  6389  |  20120610  |
